...
describe('QueryBuilder', function () {
    ...
    beforeEach(function () {
        ...
        builder = new query_builder_1.QueryBuilder(graph);
    });
    function stamp(model_name, attribute_name, slices) {
        return {
    ...
    describe('for xcrs1 models', function () {
        ...
        it('handles https://www.notion.so/ucsfdatascience/6bf73d7edfad4bd38a8527049c9f1510?v=b689c4e7890d4d2dbe3d8c6acb51a6ca&p=6d87fdcbba89412782c8b5d7d3897b5b', function () {
    ...
    it('combines multiple clauses in filters', function () {
        builder.addRootModel('monster');
    ...
    it('combines multiple subclauses in filters', function () {
        builder.addRootModel('monster');
        builder.addColumns([stamp('monster', 'name', [])]);
        builder.addRecordFilters([
            {
    ...
    it('does not wrap individual filters on root model in ::and', function () {
        builder.addRootModel('monster');
        builder.addColumns([stamp('monster', 'name', [])]);
        builder.addRecordFilters([
            {
    ...
    it('adds slice for root model', function () {
    ...
    it('adds matrix slice with multiple clauses', function () {
        builder.addRootModel('labor');
        builder.addColumns([
            stamp('labor', 'name', []),
    ...
    it('returns a count query string', function () {
        builder.addRootModel('monster');
        builder.addColumns([
            stamp('monster', 'name', []),
            stamp('labor', 'year', []),
    ...
    describe('handles any for', function () {
        it('deep paths in filters with some non-branching models', function () {
            builder.addRootModel('labor');
            builder.addRecordFilters([
                {
                    modelName: 'wound',
        ...
        it('deep paths in filters with branching models only', function () {
            builder.addRootModel('monster');
            builder.addRecordFilters([
                {
                    modelName: 'wound',
        ...
        it('shallow paths in filters with branching models', function () {
            builder.addRootModel('monster');
            builder.addRecordFilters([
                {
                    modelName: 'victim',
        ...
        it('paths that go up and down the tree', function () {
        ...
        it('paths that go up and down and terminate in a table', function () {
            builder.addRootModel('monster');
            builder.addRecordFilters([
                {
                    modelName: 'prize',
        ...
        it('paths that go up the tree', function () {
            builder.addRootModel('prize');
            builder.addRecordFilters([
                {
                    modelName: 'labor',
    ...
    describe('handles every for', function () {
        it('deep paths in filters with some non-branching models', function () {
            builder.addRootModel('labor');
            builder.addRecordFilters([
                {
        ...
        it('correctly handles numeric filters', function () {
            builder.addRootModel('monster');
            builder.addColumns([stamp('monster', 'name', [])]);
            builder.addRecordFilters([
                {
        ...
        it('correctly handles non-numeric filters', function () {
            builder.addRootModel('monster');
            builder.addColumns([stamp('monster', 'name', [])]);
            builder.addRecordFilters([
                {
