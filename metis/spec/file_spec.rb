...
describe FileController do
  ...
  context '#thumbnails' do
    ...
    it "correctly identifies when data_block has thumbnail due to other file" do
      duplicate_square = create_file("athena", "red_square_copy.png", "filler", bucket: @bucket)
      duplicate_square.data_block = @target_file.data_block
      duplicate_square.save
