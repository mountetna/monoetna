...
curl -s https://spaces.at.internet2.edu/display/MDQ/production-mdq-signing-key | sed -n '/-----BEGIN CERTIFICATE-----/,/-----END CERTIFICATE-----/{s/^.*-----BEGIN/-----BEGIN/;p}' > inc-md-cert-mdq.pem
