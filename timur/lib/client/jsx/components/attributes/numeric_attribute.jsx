...
NumericAttribute = connect(null, {reviseDocument})(NumericAttribute);

export const IntegerAttribute = (props) => (
  <NumericAttribute {...props} NumericInput={IntegerInput} />
);
export const FloatAttribute = (props) => (
  <NumericAttribute {...props} NumericInput={FloatInput} />
);
