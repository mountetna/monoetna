...
import {checkCommittedStepPending, finishPolling, setSessionFromStorage, setStatus, startPolling, VulcanAction} from '../actions/vulcan_actions';
...
// ) {
//   //dispatch(setSessionFromStorage(response.session));
