...
import BooleanInput from "./workflow/user_interactions/inputs/boolean";
import CheckboxesInput from "./workflow/user_interactions/inputs/checkboxes";
import { AnnotationEditorInput, DataTransformationInput } from "./workflow/user_interactions/inputs/data_transformation";
import FloatInput from "./workflow/user_interactions/inputs/float";
import { InputBackendComponent, InputValidator } from "./workflow/user_interactions/inputs/input_types";
import IntegerInput from "./workflow/user_interactions/inputs/integer";
import { MetisFileInput, MetisFolderInput } from "./workflow/user_interactions/inputs/metis_items";
import MultipleInput from "./workflow/user_interactions/inputs/multiple_input";
import MultiselectStringInput from "./workflow/user_interactions/inputs/multiselect_string";
...
import SelectAutocompleteInput from "./workflow/user_interactions/inputs/select_autocomplete";
...
import StringInput from "./workflow/user_interactions/inputs/string";
import { AnyDittoSeq, AnyPlotly, BarPlotly, DittoBarPlot, DittoDimPlot, DittoPlot, DittoScatterPlot, ScatterPlotly, YPlotly } from "./workflow/user_interactions/inputs/visualizations";
...
configureComponent(INPUT_TYPES.INTEGER, IntegerInput, NotEmptyValidator);
configureComponent(INPUT_TYPES.BOOL, BooleanInput, NotEmptyValidator);
configureComponent(INPUT_TYPES.METIS_FILE, MetisFileInput, MetisFileValidator());
configureComponent(INPUT_TYPES.METIS_CSV_OR_TSV, MetisFileInput, MetisFileValidator('\\.[ct]sv$', 'csv or tsv file'));
configureComponent(INPUT_TYPES.METIS_FOLDER, MetisFolderInput, MetisFolderValidator());
configureComponent(INPUT_TYPES.METIS_FILE_OR_FOLDER, MetisFileInput, MetisPathValidator());
configureComponent(INPUT_TYPES.SELECT_AUTOCOMPLETE, SelectAutocompleteInput, StronglyNotEmptyValidator);
configureComponent(INPUT_TYPES.SELECT_AUTOCOMPLETE_MULTI_PICK, SelectAutocompleteMultiPickInput, StronglyNotEmptyValidator);
configureComponent(INPUT_TYPES.CHECKBOXES, CheckboxesInput, NotEmptyValidator);
...
configureComponent(INPUT_TYPES.MULTISELECT_STRING, MultiselectStringInput, NotEmptyValidator);
...
configureComponent(INPUT_TYPES.SCATTER_PLOTLY, ScatterPlotly, PlusSubsetValidator('rows_use',AllOutputValuesNotEmptyValidator));
configureComponent(INPUT_TYPES.BAR_PLOTLY, BarPlotly, PlusSubsetValidator('rows_use',AllOutputValuesNotEmptyValidator));
configureComponent(INPUT_TYPES.Y_PLOTLY, YPlotly, PlusSubsetValidator('rows_use',AllOutputValuesNotEmptyValidator));
configureComponent(INPUT_TYPES.ANY_VIZ, AnyPlotly, PlusSubsetValidator('rows_use',AllOutputValuesNotEmptyValidator));
configureComponent(INPUT_TYPES.DITTOSEQ_DIM_PLOT, DittoDimPlot, PlusSubsetValidator('cells_use',AllOutputValuesNotEmptyAllowingEmptyArrayValidator));
configureComponent(INPUT_TYPES.DITTOSEQ_SCATTER_PLOT, DittoScatterPlot, PlusSubsetValidator('cells_use',AllOutputValuesNotEmptyAllowingEmptyArrayValidator));
configureComponent(INPUT_TYPES.DITTOSEQ_PLOT, DittoPlot, PlusSubsetValidator('cells_use',AllOutputValuesNotEmptyAllowingEmptyArrayValidator));
configureComponent(INPUT_TYPES.DITTOSEQ_BAR_PLOT, DittoBarPlot, PlusSubsetValidator('cells_use',AllOutputValuesNotEmptyAllowingEmptyArrayValidator));
configureComponent(INPUT_TYPES.ANY_DITTOSEQ, AnyDittoSeq, PlusSubsetValidator('cells_use',AllOutputValuesNotEmptyAllowingEmptyArrayValidator));
