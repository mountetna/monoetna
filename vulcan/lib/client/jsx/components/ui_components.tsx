...
configureComponent(INPUT_TYPES.STRING, StringInput, NotEmptyValidator, ['value'], ['a']);
configureComponent(INPUT_TYPES.FLOAT, FloatInput, NotEmptyValidator, ['value'], ['a']);
configureComponent(INPUT_TYPES.INTEGER, IntegerInput, NotEmptyValidator, ['value'], ['a']);
configureComponent(INPUT_TYPES.BOOL, BooleanInput, NotEmptyValidator, ['value'], ['a']);
