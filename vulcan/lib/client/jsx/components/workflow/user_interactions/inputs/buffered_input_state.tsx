...
export function useBufferedInputState<T>(input: InputSpecification, d: T): [T, Dispatch<SetStateAction<T>>] {
  const {default: inputValue} = input;
  const [value, setValue] = useState(
    inputValue === null ? d : inputValue
  );
