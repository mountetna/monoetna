...
if experiments!='all':
    selection_terms.append(
        ["biospecimen", "::all",
        "subject", "::all",
        "experiment", "::identifier", '::in', experiments])
if tissues!='all':
    selection_terms.append(
