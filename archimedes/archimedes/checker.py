...
class ArchimedesDslChecker(BaseChecker):
    ...
    UNSAFE_NAMES = {
        'getattr', 'setattr', 'delattr', 'hasattr', 'compile', '__builtins__',
        '__module__', '__name__', 'eval', 'exec', 'locals', 'globals',
        '__package__', '__spec__', '__loader__', '__import__',
        '__debug__', '__doc__', '__build_class__', 'exit', 'quit'
    }
