...
export default class ResultTable extends React.Component {
  ...
  table() {
    ...
    return (
      <TableViewer pages={-1} page_size={10} columns={columns} data={data} />
    );
  }
  ...
  render() {
    ...
    return (
      <div className='consignment-item'>
        <i
          className={`table-visibility icon fa fa-fw fa-${icon}`}
        ...
        />
        <i
          className='download icon fa fa-fw fa-download'
          title='Download'
          onClick={onDownload}
        />
