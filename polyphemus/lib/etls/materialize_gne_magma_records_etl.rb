...
class Polyphemus::MaterializeGneMagmaRecordsEtl < Polyphemus::MagmaRecordEtl
  ...
  MATERIALIZE_ATTRIBUTES = {
      ...
      'timepoint' => [
          ...
          'o2high',
          "who_scale",
          "sofa_score", "sofa_urine", "sofa_renal", "sofa_gcs", "sofa_cardio", "sofa_liver", "sofa_coag", "sofa_resp_calc", "sofa_resp", "rrt_type", "rrt", "vasopressors_used", "ecmo_stop", "ecmo_start", "ecmo", "nippv"
      ],
      'treatment' => [
          'created_at',
          'updated_at',
