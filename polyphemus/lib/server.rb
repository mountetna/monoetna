...
class Polyphemus
  class Server < Etna::Server
    ...
    post '/api/workflows/:project_name/configs/:config_id', action: 'workflow#list_by_id', auth: { user: { can_edit?: :project_name } }
    get '/api/workflows/:project_name/configs', action: 'workflow#list', auth: { user: { can_edit?: :project_name } }
    ...
    get '/api/workflows/:project_name/revisions/:config_id', action: 'workflow#revisions', auth: { user: { can_edit?: :project_name } }

    get '/api/workflows/:project_name/run/:run_id', action: 'workflow#get_run', auth: { user: { can_edit?: :project_name } }
